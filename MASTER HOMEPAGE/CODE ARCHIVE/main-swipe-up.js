...
function init() {
  ...
  function loaderIn() {
    ...
    loader.set(swipeup, {
      autoAlpha: 1,
      attr: { d: "M 0 1 V 1 Q 0.5 1 1 1 V 1 z" } //bottom line
    });

    loader.to(swipeup, {
      duration: 0.8,
      ease: "power4.in",
      attr: { d: "M 0 1 V 0.5 Q 0.5 0 1 0.5 V 1 z" } //arc top
    });

    loader.to(swipeup, {
      duration: 0.6,
      ease: "power2",
      attr: { d: "M 0 1 V 0 Q 0.5 0 1 0 V 1 z" } //full square
    });
  ...
  function loaderAway() {
    ...
    loader.to(swipeup, {
      duration: 0.4,
      ease: "power4.in",
      attr: { d: "M 0 1 V 0.5 Q 0.5 1 1 0.5 V 1 z" } //arc dip
    });

    loader.to(swipeup, {
      duration: 0.3,
      ease: "power2",
      attr: { d: "M 0 1 V 1 Q 0.5 1 1 1 V 1 z" } //bottom line final
...
// scroll to the top of the page (bck/fwd browser buttons to manual)
