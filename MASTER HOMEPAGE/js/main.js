  ...
  timeout: 5000,
    views: [
      ...
      },
      {
        ...
        beforeEnter() {
          window.onload = initCreativeDirectionAnims(); 
          console.log("CREATIVE DIRECTION VIEW WORKING on page load");
        }
      },
      {
...
//// END BORDER-LINE 1 CODE ////
  ...
  gsap.utils.toArray(".hover-container").forEach((el, index) => {
...
tlcontoursFade.to("#contours", { opacity: 1, duration: 2 });
